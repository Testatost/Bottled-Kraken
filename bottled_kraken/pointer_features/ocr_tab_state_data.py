...
try:
    from bottled_kraken._main_window.ocr_variant_tabs import configure_ocr_variant_tab_buttons, ocr_variant_tab_display_text, ocr_variant_tab_plain_text
    from bottled_kraken._main_window.ocr_tab_name_utils import is_generated_ocr_tab_label, persistent_ocr_tab_name
except Exception:
...
__all__ = [
    '_ORIGINAL_LOAD_RESULTS',
    '_ORIGINAL_ON_FILE_DONE',
    '_ORIGINAL_PREVIEW_IMAGE',
    '_ORIGINAL_START_OCR',
    '_ORIGINAL_TASK_FROM_DICT',
    '_ORIGINAL_TASK_TO_DICT',
    '_ocr_tab_add',
    '_ocr_tab_apply',
    '_ocr_tab_blank_entry',
    '_ocr_tab_clone_recs',
    '_ocr_tab_configure_tab_ui',
    '_ocr_tab_current_path',
    '_ocr_tab_current_results',
    '_ocr_tab_default_label',
    '_ocr_tab_delete',
    '_ocr_tab_entries',
    '_ocr_tab_entry_from_results',
    '_ocr_tab_find_task',
    '_ocr_tab_label',
    '_ocr_tab_model_name',
    '_ocr_tab_next_number',
    '_ocr_tab_next_visible_number',
    '_ocr_tab_normalize_entries',
    '_ocr_tab_on_changed',
    '_ocr_tab_recs_from_text',
    '_ocr_tab_refresh',
    '_ocr_tab_rename',
    '_ocr_tab_results_from_entry',
    '_ocr_tab_save_active',
    '_ocr_tab_stable_number',
    '_ocr_tab_tooltip',
    '_ocr_tab_visible_tab_name',
    '_ocr_tab_visible_texts',
]
