...
def _ptr_start_multi_ocr_v3(self):
    ...
    job = PtrMultiOCRJob(
        ...
        runs=dlg.runs(),
        image_variants_enabled=(dlg.image_variants_enabled() if hasattr(dlg, "image_variants_enabled") else False),
        image_variant_count=(dlg.image_variant_count() if hasattr(dlg, "image_variant_count") else 1),
    )
...
def _ptr_remove_secondary_feature_buttons_v4(window):
    for attr in ("btn_ptr_multi_ocr_bottom", "btn_ptr_openrouter_ai_bottom"):
        ...
        try:
            ...
            pass
__all__ = [
    '_ptr_export_ai_merge_for_current_v3',
    '_ptr_export_ai_neo4j_for_current_v3',
    '_ptr_export_ai_postgres_for_current_v3',
    '_ptr_mainwindow_stop_ocr_wrapper_v3',
    '_ptr_on_multi_batch_finished_v3',
    '_ptr_on_multi_failed_v3',
    '_ptr_on_multi_file_error_v3',
    '_ptr_on_multi_file_started_v3',
    '_ptr_open_ai_tools_for_current_task_v3',
    '_ptr_open_multi_followup_for_path_v3',
    '_ptr_queue_context_menu_v3',
    '_ptr_remove_secondary_feature_buttons_v4',
    '_ptr_remove_toolbar_feature_buttons_v4',
    '_ptr_reopen_multi_followup_v3',
    '_ptr_start_multi_ocr_v3',
    '_ptr_store_ai_neo4j_v3',
    '_ptr_store_ai_postgres_v3',
]
