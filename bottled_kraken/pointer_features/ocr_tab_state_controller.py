...
__all__ = [
    '_ocr_tab_entry_from_project',
    '_ocr_tab_entry_to_project',
    '_ocr_tab_load_results',
    '_ocr_tab_multi_done',
    '_ocr_tab_on_file_done',
    '_ocr_tab_preview_image',
    '_ocr_tab_retranslate',
    '_ocr_tab_start_ocr',
    '_ocr_tab_task_from_dict',
    '_ocr_tab_task_to_dict',
]
