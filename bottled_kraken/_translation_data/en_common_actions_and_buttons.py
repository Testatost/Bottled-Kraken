...
EN_COMMON_ACTIONS_AND_BUTTONS_TRANSLATIONS = {'ai_prompt_single_system': 'Du bist ein präziser OCR- und Transkriptionsassistent für historische deutsche Handschriften und Formulare.\n'
 ...
 'ai_prompt_decision_system': 'Du bist ein präziser OCR-Korrekturassistent für historische deutsche Handschriften und Formulare.\n'
                              ...
                              'Antworte ausschließlich mit gültigem JSON.\n'
                              'Kein Markdown. Kein Zusatztext. Kein Kommentar.\n'
                              'IMPORTANT: Double quotation marks (") and sequences such as -"- in registers are often ditto/repetition marks. Do not treat '
                              'them literally; replace them with the corresponding value from the line above or the same column in the previous entry.',
