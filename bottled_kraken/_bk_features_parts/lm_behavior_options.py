"""Einstellbares Verhalten der lokalen LM-Zeilenüberarbeitung."""
...
# Migration aliases for older settings written by previous builds.
# Older dialogs used "weight" / "weighting"; newer code exposes the same choice
# as "revision_mode" in the UI contract.  All three keys normalize to "weight"
# internally so existing user profiles keep their behavior.
...
def _bk_lm_behavior_normalized(data=None) -> dict:
    ...
    # Wichtig: ältere Builds haben parallel revision_mode/weighting gespeichert.
    # Runtime darf später keinen veralteten Alias vor dem aktuellen Dialogwert
    # lesen, sonst wirkt z.B. "LM-OCR > Kraken-OCR" weiterhin wie Kraken.
