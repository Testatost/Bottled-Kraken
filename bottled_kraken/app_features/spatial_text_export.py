...
__all__ = [
    ...
    '_bk_fix38_mainwindow_init',
    '_bk_fix38_prev_value',
    '_bk_fix38_remove_old_origami_actions',
    '_bk_fix38_resolve_ditto_marks_in_lines',
    '_bk_fix38_retranslate_ui',
    '_bk_fix38_spatial_text_from_recs',
    '_bk_fix38_sync_ui_after_recs_change',
    '_bk_fix38_token_fields',
    '_bk_fix38b_mainwindow_init',
    '_bk_fix38b_retranslate_ui',
]
