...
def _bk_prepare_sort_items_v20_final(records, image_width: int = 0, image_height: int = 0, *, deskew: bool = True):
    ...
    return items, med_h
__all__ = [
    '_bk_detect_column_splits_v20',
    '_bk_lm_collect_current_text',
    '_bk_lm_collect_current_text_v19',
    '_bk_lm_generate_local_json',
    '_bk_lm_generate_local_json_v19',
    '_bk_prepare_sort_items_v20',
    '_bk_prepare_sort_items_v20_final',
    '_bk_sort_items_row_major_v20',
    '_bk_sort_records_handwriting_simple_v19',
    '_bk_sort_records_reading_order_v19',
    '_bk_sort_records_strict_v20',
