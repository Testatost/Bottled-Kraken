...
def _bk_local_json_request_object(self, system_prompt: str, user_prompt: str) -> Dict[str, Any]:
    ...
    if isinstance(obj, dict):
        return obj
    raise RuntimeError(self._tr('ai_err_invalid_json', self._tr('err_json_top_level_object_expected')))
...
__all__ = [
    '_bk_build_local_neo4j_json',
    '_bk_emit_usage_progress',
    '_bk_extract_nested_json_candidate',
    '_bk_extract_token_usage',
    '_bk_is_name_like',
    '_bk_local_json_build_postgres_v9',
    '_bk_local_json_request_object',
    '_bk_local_json_request_payload',
    '_bk_looks_like_given_block',
    '_bk_looks_like_surname',
    '_bk_name_tokens',
    '_bk_prev_ptr_normalize_postgres_json_v9',
    '_bk_prune_given_names',
    '_bk_split_person_name_heuristic',
    '_ptr_normalize_postgres_json',
    '_ptr_normalize_postgres_json_v9',
]
