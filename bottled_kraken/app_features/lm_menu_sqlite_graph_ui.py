...
def _bk_ui_ensure_lm_menu_order(self):
    ...
    _bk_ui_connect_action_once(self.act_ai_menu_canonical_load, lambda: _bk_lm_load_canonical_graph_json(self))
    ...
    label_pairs = [
        ...
        ("act_ai_menu_canonical_load", "lm_menu_load_canonical_graph"),
    ...
    _add("act_ai_menu_canonical_load")
...
__all__ = [
    ...
    '_bk_ui_connect_action_once',
    '_bk_ui_ensure_lm_menu_order',
    '_bk_ui_ensure_overlay_resize_in_edit_menu',
    '_bk_ui_mainwindow_init',
    '_bk_ui_overlay_visible_rows_for_mode',
    '_bk_ui_rebuild_overlay_menu',
    '_bk_ui_retranslate_ui',
    '_bk_ui_scale_overlay_boxes',
    '_bk_ui_set_overlay_display_mode',
]
