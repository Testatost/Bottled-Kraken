...
class BKQueueLMBatchWorker(QThread):
    file_started = Signal(str, int, int, str)
    file_finished = Signal(str, str, object, object, int, int)
    file_failed = Signal(str, str, int, int)
    file_skipped = Signal(str, str, int, int)
    ...
    def run(self):
        ...
        self.finished_batch.emit()
__all__ = [
    'BKFullPageLMOCRWorker',
    'BKQueueLMBatchWorker',
    '_BK_TEST_CONTRACT_BATCH_GLOBAL_ROW_MARKER',
]
