...
class BKCanonicalGraphView(QGraphicsView):
    ...
    def mouseReleaseEvent(self, event):
        ...
        super().mouseReleaseEvent(event)
__all__ = [
    'BKCanonicalGraphClusterBubbleItem',
    'BKCanonicalGraphClusterLabelHandle',
    'BKCanonicalGraphEdgeItem',
    'BKCanonicalGraphNodeItem',
    'BKCanonicalGraphView',
    'BKCanonicalOutlinedText',
]
