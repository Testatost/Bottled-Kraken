...
try:
    ...
    pass
__all__ = [
    '_BK_GEDCOM_REG_SOURCE_PREV_RUN',
    '_bk_gedcom_reg_extract_from_source_line',
    '_bk_gedcom_reg_source_age_match',
    '_bk_gedcom_reg_source_clean',
    '_bk_gedcom_reg_source_date_match',
    '_bk_gedcom_reg_source_is_heading',
    '_bk_gedcom_reg_source_line_text',
    '_bk_gedcom_reg_source_split_name',
    '_bk_gedcom_registrations_from_text',
    '_bk_gedcom_response_format_structured',
    '_bk_gedcom_source_text_looks_like_register',
    '_bk_gedcom_worker_run_registration_source',
]
