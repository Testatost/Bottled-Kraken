...
def _bk_local_json_post_json_v21(self, payload: dict) -> dict:
    ...
    try:
        ...
        self._active_socket = None
__all__ = [
    '_bk_detect_columns_v21',
    '_bk_group_rows_v21',
    '_bk_local_json_post_json_v21',
    '_bk_prepare_sort_items_v21',
    '_bk_sort_records_handwriting_simple_v21',
    '_bk_sort_records_reading_order_v21',
    '_bk_sort_records_strict_v21',
    '_bk_sort_single_flow_v21',
