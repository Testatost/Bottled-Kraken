...
__all__ = [name for name in globals() if not name.startswith("__")]
__all__ = [
    '_adaptive_column_anchors',
    '_bbox_table_rows',
    '_clean_table_cell_text',
    '_compact_grid',
    '_compact_grid_row',
    '_extract_text_lines',
    '_nearest_anchor_index',
    '_normalize_bbox',
    '_normalize_grid_width',
    '_rows_from_explicit_separators',
    '_split_textual_table_cells',
    '_trim_grid_row_edges',
    'clip_polygon_halfplane',
    'docx_layout_blocks',
    'pil_to_qpixmap',
    'polygon_area',
    'render_pdf_page_to_pil',
    'table_to_rows',
    'table_to_rows_two_columns',
]
