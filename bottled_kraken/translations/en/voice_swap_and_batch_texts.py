EN_VOICE_SWAP_AND_BATCH_TEXTS_TRANSLATIONS = {
    ...
    'warn_no_matching_import_for_selected': (
        'No import file matches the selected images.\n\nThe filenames must match by base name.'
),
    'warn_no_matching_import_for_loaded': (
    ...
    'hf_error_command_exit': (
        'Command exited with code {}:\n{}'
),
    'hf_error_python_missing': (
        'Python or a required module could not be found.\n\nPlease check whether the application is running with a working Python environment.'
),
    'hf_error_externally_managed': (
        'The system Python installation must not be modified directly.\n\nThe app should automatically use its own environment for this. If this still happened, python3-venv is probably missing.\n\nPlease run:\nsudo apt update\nsudo apt install -y python3-venv python3-pip'
),
    'hf_error_no_venv': (
        'Python venv support is missing on this system.\n\nPlease run:\nsudo apt update\nsudo apt install -y python3-venv python3-pip'
),
    'hf_error_python3_missing': (
