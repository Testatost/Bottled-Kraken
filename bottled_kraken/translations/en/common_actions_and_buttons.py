...
EN_COMMON_ACTIONS_AND_BUTTONS_TRANSLATIONS = {'ai_prompt_single_system': 'Du bist ein präziser OCR- und Transkriptionsassistent für historische deutsche Handschriften und Formulare.\n'
                            'Du liest genau eine einzelne Zielzeile aus einem Bildausschnitt.\n'
                            'Das Bild ist die einzige Wahrheitsquelle.\n'
                            'IMPORTANT: Double quotation marks (") and sequences such as -"- in registers are often ditto/repetition marks. Do not treat them '
                            'literally; replace them with the corresponding value from the line above or the same column in the previous entry.\n'
                            'A single quotation mark (") in tables or registers usually means: repeat the corresponding value from the line above; resolve '
                            'such repetition marks from context.\n'
 ...
 'image_edit_applied_single_status': "Image editing applied. Edited images were saved in the folder 'Bottled Kraken edited Bilder' and added to the queue as "
                                     'new entries.',
 ...
 'dlg_lm_url_label': '<div class="card">\n'
                     ...
                     '                <li>For Ollama in Bottled Kraken, normally use the OpenAI-compatible <code>/v1</code> URL, not the native '
                     '<code>/api</code> URL.</li>\n'
                     '            </ul>\n'
                     '        </div>',
 ...
 'help_html_image_edit': '\n'
                         ...
                         '                <ul>\n'
                         '                    <li>If rotation is active, fine-tune the crop area and separator bar only after switching back to '
...
# PATCH49_LM_REVISION_SANITY_PROMPTS_EN_COMMON_ACTIONS_AND_BUTTONS_TRANSLATIONS
EN_COMMON_ACTIONS_AND_BUTTONS_TRANSLATIONS.update({'ai_prompt_decision_system': 'You are a precise OCR correction assistant for historical handwriting, printed text, tables, and forms.\nYou receive three candidates for exactly one target line:\n1. the previous Kraken/line text\n2. OCR from the local page/block context\n3. OCR from this line\'s overlay box\n\nTask:\n- Produce the best corrected version for exactly this one target line.\n- Kraken remains the conservative anchor and must not be overwritten without reason.\n- LM OCR may improve Kraken if it plausibly adds missing words, characters, spaces, or corrects clear misreadings.\n- No name, place, date, age, year or number from a plausible Kraken text may disappear.\n- Use page/block context only when it matches the target line; never copy neighbouring lines.\n- Preserve historical spelling and original names/numbers.\n- Do not invent information.\n- Never return more than one line.\nReply only with valid JSON.\nNo Markdown. No extra text. No comments.\nIMPORTANT: Double quotation marks (") and sequences such as -"- are often ditto marks in registers. Do not output them literally; replace them with the corresponding value from the line above or the same column in the previous entry.', 'ai_prompt_decision_user': 'Target line idx={}\n\nPrevious Kraken/line text:\n{}\n\nPage/block context OCR:\n{}\n\nOverlay-box OCR:\n{}\n\nCompare the three candidates and return the best corrected version for EXACTLY this one target line.\nThe target text may differ from the previous Kraken text if LM OCR passes the sanity check and provides a more complete or clearer reading.\nNo neighbouring line, no explanation, no Markdown.\nExact format:\n{{"text":"..."}}',
    ...
    'kraken_revision_replacements_placeholder': 'ſ=s\n⸗=-\n±=+/-',
