...
EN_IMAGE_EDIT_TEXTS_TRANSLATIONS = {
    ...
    "pdf_export_write_blocked": "The PDF file cannot be written:\n\n{}\n\nIt may still be open in another program.",
    ...
    "log_external_backend_fallback_cpu": "External OCR backend for {} is not available; CPU OCR is used instead.",
    ...
    "hw_install_cuda_backend": "Install CUDA (NVIDIA)",
    "hw_install_rocm_backend": "Install ROCm (AMD)",
    "backend_install_title_nvidia": "Install NVIDIA CUDA backend",
    "backend_install_title_rocm": "Install AMD ROCm backend",
    "backend_install_intro_nvidia": "Installs a separate NVIDIA CUDA backend with its own Python environment, PyTorch CUDA, TorchVision and Kraken. The Bottled Kraken CPU one-file app is not modified.",
    "backend_install_intro_rocm": "Installs a separate AMD ROCm backend with its own Python environment, PyTorch ROCm, TorchVision and Kraken. The Bottled Kraken CPU one-file app is not modified.",
    ...
    "backend_install_platform": "Detected operating system:",
...
# PATCH_UI_FINAL_20260525_CORE_EN
EN_IMAGE_EDIT_TEXTS_TRANSLATIONS.update({'menu_export': 'Export as... (Ctrl+E)', 'line_menu_move_up_page': 'Move line(s) up (Page Up shortcut)', 'line_menu_move_down_page': 'Move line(s) down (Page Down shortcut)'})


# PATCH_UI_SHORTCUT_LABELS_20260525
EN_IMAGE_EDIT_TEXTS_TRANSLATIONS.update({'menu_export': 'Export as...\\tCtrl+E', 'line_menu_move_up_page': 'Move line(s) up (Page ↑)', 'line_menu_move_down_page': 'Move line(s) down (Page ↓)'})

# UI shortcut labels are added by QAction/menu code, not translations.
EN_IMAGE_EDIT_TEXTS_TRANSLATIONS.update({'menu_export': 'Export as...'})
