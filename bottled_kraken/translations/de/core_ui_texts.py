DE_CORE_UI_TEXTS_TRANSLATIONS = {
    ...
    'log_external_backend_fallback_cpu': 'Externes OCR-Backend für {} nicht verfügbar; CPU-OCR wird verwendet.',
    ...
    'hw_install_cuda_backend': 'CUDA (NVIDIA) installieren',
    'hw_install_rocm_backend': 'ROCm (AMD) installieren',
    'backend_install_title_nvidia': 'NVIDIA CUDA Backend installieren',
    'backend_install_title_rocm': 'AMD ROCm Backend installieren',
    'backend_install_intro_nvidia': 'Installiert ein separates NVIDIA-CUDA-Backend mit eigener Python-Umgebung, PyTorch CUDA, TorchVision und Kraken. Die Bottled-Kraken-CPU-Onefile-App wird nicht verändert.',
    'backend_install_intro_rocm': 'Installiert ein separates AMD-ROCm-Backend mit eigener Python-Umgebung, PyTorch ROCm, TorchVision und Kraken. Die Bottled-Kraken-CPU-Onefile-App wird nicht verändert.',
    'backend_install_target': 'Installationsziel:',
    'backend_install_warning': 'Es können mehrere Gigabyte heruntergeladen werden. Eine Internetverbindung ist erforderlich.',
    'backend_install_force': 'Vorhandenes Backend vorher löschen und neu installieren',
    'backend_install_start': 'Installation starten',
    'backend_install_close': 'Schließen',
    'backend_install_log': 'Installationsprotokoll:',
    'backend_install_running': 'Die Installation läuft bereits.',
    'backend_install_active': 'Download/Installation läuft ...',
    'backend_install_success': 'Backend-Installation wurde erfolgreich abgeschlossen.',
    'backend_install_failed': 'Backend-Installation ist fehlgeschlagen.',
    'backend_install_finished': 'Installation abgeschlossen',
    'backend_install_choose_python_failed': 'Es wurde kein geeignetes Python gefunden.',
    'backend_install_platform': 'Erkanntes Betriebssystem:',
    'backend_install_unsupported': 'Dieses Backend wird auf diesem Betriebssystem noch nicht unterstützt.',
