...
DE_CORE_UI_TEXTS_TRANSLATIONS = {
    ...
    "pdf_export_write_blocked": "Die PDF-Datei kann nicht geschrieben werden:\n\n{}\n\nMöglicherweise ist sie noch in einem anderen Programm geöffnet.",
...
# PATCH_UI_FINAL_20260525_CORE_DE
DE_CORE_UI_TEXTS_TRANSLATIONS.update({'menu_export': 'Exportieren als... (Strg+E)', 'line_menu_move_up_page': 'Zeile(n) nach oben verschieben (Bild hoch-Shortcut)', 'line_menu_move_down_page': 'Zeile(n) nach unten verschieben (Bild runter-Shortcut)'})


# PATCH_UI_SHORTCUT_LABELS_20260525
DE_CORE_UI_TEXTS_TRANSLATIONS.update({'menu_export': 'Exportieren als...\\tStrg+E', 'line_menu_move_up_page': 'Zeile(n) nach oben verschieben (Bild ↑)', 'line_menu_move_down_page': 'Zeile(n) nach unten verschieben (Bild ↓)'})

# UI shortcut labels are added by QAction/menu code, not translations.
DE_CORE_UI_TEXTS_TRANSLATIONS.update({'menu_export': 'Exportieren als...',
