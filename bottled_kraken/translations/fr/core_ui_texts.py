FR_CORE_UI_TEXTS_TRANSLATIONS = {
    ...
    'log_external_backend_fallback_cpu': 'Le backend OCR externe pour {} n’est pas disponible ; l’OCR CPU est utilisé à la place.',
    ...
    'hw_install_cuda_backend': 'Installer CUDA (NVIDIA)',
    'hw_install_rocm_backend': 'Installer ROCm (AMD)',
    'backend_install_title_nvidia': 'Installer le backend NVIDIA CUDA',
    'backend_install_title_rocm': 'Installer le backend AMD ROCm',
    'backend_install_intro_nvidia': 'Installe un backend NVIDIA CUDA séparé avec son propre environnement Python, PyTorch CUDA, TorchVision et Kraken. L’application CPU one-file de Bottled Kraken n’est pas modifiée.',
    'backend_install_intro_rocm': 'Installe un backend AMD ROCm séparé avec son propre environnement Python, PyTorch ROCm, TorchVision et Kraken. L’application CPU one-file de Bottled Kraken n’est pas modifiée.',
    'backend_install_target': 'Destination d’installation :',
    'backend_install_warning': 'Plusieurs gigaoctets peuvent être téléchargés. Une connexion Internet est nécessaire.',
    'backend_install_force': 'Supprimer d’abord le backend existant et réinstaller',
    'backend_install_start': 'Démarrer l’installation',
    'backend_install_close': 'Fermer',
    'backend_install_log': 'Journal d’installation :',
    'backend_install_running': 'L’installation est déjà en cours.',
    'backend_install_active': 'Téléchargement/installation en cours ...',
    'backend_install_success': 'L’installation du backend s’est terminée avec succès.',
    'backend_install_failed': 'L’installation du backend a échoué.',
    'backend_install_finished': 'Installation terminée',
    'backend_install_choose_python_failed': 'Aucun interpréteur Python approprié n’a été trouvé.',
    'backend_install_platform': 'Système d’exploitation détecté :',
    'backend_install_unsupported': 'Ce backend n’est pas encore pris en charge sur ce système d’exploitation.',
