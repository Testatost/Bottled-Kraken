...
FR_CORE_UI_TEXTS_TRANSLATIONS = {
    ...
    "pdf_export_write_blocked": "Le fichier PDF ne peut pas être écrit :\n\n{}\n\nIl est peut-être encore ouvert dans un autre programme.",
...
# PATCH_UI_FINAL_20260525_CORE_FR
FR_CORE_UI_TEXTS_TRANSLATIONS.update({'menu_export': 'Exporter en tant que... (Ctrl+E)', 'line_menu_move_up_page': 'Déplacer la/les ligne(s) vers le haut (raccourci Page précédente)', 'line_menu_move_down_page': 'Déplacer la/les ligne(s) vers le bas (raccourci Page suivante)'})


# PATCH_UI_SHORTCUT_LABELS_20260525
FR_CORE_UI_TEXTS_TRANSLATIONS.update({'menu_export': 'Exporter en tant que...\\tCtrl+E', 'line_menu_move_up_page': 'Déplacer la/les ligne(s) vers le haut (Page ↑)', 'line_menu_move_down_page': 'Déplacer la/les ligne(s) vers le bas (Page ↓)'})

# UI shortcut labels are added by QAction/menu code, not translations.
FR_CORE_UI_TEXTS_TRANSLATIONS.update({'menu_export': 'Exporter en tant que...',
