...
class ImageEditSettings:
    ...
    crop_areas_orig: List[Tuple[int, int, int, int]] = field(default_factory=list)
    active_crop_index: int = -1
    ...
    transform_src_norm: Optional[Tuple[float, float, float, float]] = None
    transform_dest_norm: Optional[List[Tuple[float, float]]] = None
    transform_source_order: Tuple[int, int, int, int] = (0, 1, 2, 3)
    transform_rotate_angle: float = 0.0
