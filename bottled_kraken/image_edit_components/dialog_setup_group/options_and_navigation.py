...
class ImageEditDialogOptionsAndNavigationMixin:
        ...
        def _refresh_preview(self, reset_zoom: bool = False):
            ...
            # Auswahlbereich absichtlich NICHT automatisch restaurieren:
            # Er soll nur durch echte Maus-Ziehbewegung erscheinen.
        ...
        def _sync_from_canvas(self):
            # Nicht self.rotation_angle aus canvas.rotation_angle zurücksetzen.
            # Die globale Rotation wird über Buttons oder rotation_committed gesetzt.
            self._sync_transform_mode_buttons()
