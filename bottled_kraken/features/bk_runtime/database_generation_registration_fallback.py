"""Register-/Tabellenseiten als PostgreSQL-, Neo4j- und SQLite-Daten erzeugen.

Diese Runtime-Schicht nutzt dieselbe deterministische Register-Erkennung wie der
GEDCOM-Fallback, greift aber nur in die Datenbank-/JSON-Erzeugung ein. Die
LM-Zeilenüberarbeitung bleibt unberührt.
"""
...
def _bk_db_neo4j_from_register_rows(source_text: str, rows: list) -> dict:
    ...
    # Wenn der bestehende Graph-Builder aktiv ist, nutzt er das jetzt gepatchte PostgreSQL-Fallback.
