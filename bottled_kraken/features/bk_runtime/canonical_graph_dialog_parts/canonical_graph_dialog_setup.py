...
class BKCanonicalGraphDialogSetupMixin:
        ...
        def _normalize_for_view(self):
            ...
            for ent in entities:
                ...
                # Keep DOCUMENT in canonical JSON, but do not render/table it by default:
                # document hub nodes create unreadable star graphs for register pages.
            ...
            # Add relation-derived fields for meaningful clustering, e.g. shared place/year.
