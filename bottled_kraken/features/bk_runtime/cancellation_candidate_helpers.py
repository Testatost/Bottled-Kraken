...
def _bk_fix43_reset_mainwindow_after_cancel(self):
    """Bringt die Oberfläche nach Stop/Cancel defensiv in den Ausgangszustand zurück."""
    try:
...
def _bk_fix43_request_cancel_on_object(obj):
    """Setzt möglichst alle bekannten Cancel-/Interrupt-Mechanismen eines Workers/Threads."""
    if obj is None:
        return
