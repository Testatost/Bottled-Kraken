...
for file in (
    ...
    "splash.png",
    "logo.png",
    "Bottled Kraken Programm v3.3.png",
    "Bottled Kraken Programm v3.2.png",
    "Bottled Kraken Screenshot v3.1.png",
    "README.md",
    "LICENSE",
    "Kurzhinweise - Bottled Kraken.txt",
    "windows_10_11_installation_quellcode.txt",
):
    add_file(file, ".")
for folder in (
...
hiddenimports.extend(safe_submodules("bottled_kraken.translations"))
hiddenimports.extend(safe_submodules("bottled_kraken._workers"))
hiddenimports.extend(safe_submodules("bottled_kraken.common"))
hiddenimports.extend(safe_submodules("bottled_kraken.pointer_features"))
hiddenimports.extend(safe_submodules("bottled_kraken.app_features"))
